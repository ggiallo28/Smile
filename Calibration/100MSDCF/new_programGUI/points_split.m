...
% LOGIC
    ...
    %         end
            if ~Container.isGUI
                ...
                cla(Container.app.UIAxes10);
                imshow(I,'Parent',Container.app.UIAxes10); hold(Container.app.UIAxes10,'on');
                scatter(Container.app.UIAxes10,x_cj_matrix_copy(:),y_rj_matrix_copy(:));
                drawnow;
                pause(0.25)
            end
        end    

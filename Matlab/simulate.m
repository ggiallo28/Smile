function texx = simulate(anglebetweenmirrors, isIdealCamera, distancecamera, fovcamera, lengthmirror, pivot2pivotdistance, offsetmirror, mirror2pivot, figure1, figure2)
    ...
    plot(figure2, [0 pivot2pivot], [0 0],'b');
    plot(figure2, [0 inPointLeft(1)], [0 -inPointLeft(2)],'b');
    plot(figure2, [pivot2pivot inPointRight(1)], [0 -inPointRight(2)],'b');
    ...
    scatter(figure2, mirrorsCenter(1),mirrorsCenter(2));
    scatter(figure2, cameraCenter(1),cameraCenter(2));
    plot(figure2, el_x,el_y,'b')

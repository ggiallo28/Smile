...
%
%-------------------------------------------------------------%
function [output_peak, output_minima_low, output_minima_high] = finddataminima(array,mpd,windowSize,refine)
...
thresh = size(array,1)*size(array,2)*0.01;
...
output_minima_low(output_minima_low<output_peak(1) | output_minima_low>output_peak(end)) = [];
output_minima_high(output_minima_high<output_peak(1) | output_minima_high>output_peak(end)) = [];
